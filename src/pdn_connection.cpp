...
// Добавить Bearer в PDN Connection
void pdn_connection::add_bearer(std::shared_ptr<bearer> bearer_ptr) {
    _bearers[bearer_ptr->get_dp_teid()] = std::move(bearer_ptr);
}

// Удалить Bearer из PDN Connection
